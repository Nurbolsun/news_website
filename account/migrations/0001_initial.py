    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(blank=True, max_length=25, null=True, verbose_name='Имя пользователя')),
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Админ'), ('USER', 'Пользователь'), ('JOURNALIST', 'Журналист'), ('GUEST', 'Гость')], default='GUEST', max_length=200, verbose_name='Роль')),
